...
def manually_fill():
    ...
    def fill_attendance():
        ...
        if subb=='':
            ...
            def attf():
                import subprocess
                subprocess.Popen(r'explorer /select,"C:\Users\DELL\Documents\AllProjects\python projects\AMS\Attendance\Manually Attendance\-------Check atttendance-------"')
...
def subjectchoose():
    def Fillattendances():
        ...
        if time.time() < future:
            if sub == '':
                ...
                root.configure(background='snow')
                cs = 'C:/Users/DELL/Documents/AllProjects/python projects/AMS/' + fileName
    ...
    def Attf():
        import subprocess
        subprocess.Popen(r'explorer /select,"C:\Users\DELL\Documents\AllProjects\python projects\AMS\Attendance\-------Check atttendance-------"')
    ...
    def log_in():
        ...
        if username == 'admin' :
            if password == 'admin':
                ...
                cs = 'C:/Users/DELL/Documents/AllProjects/python projects/AMS/StudentDetails/StudentDetails.csv'
                with open(cs, newline="") as file:
                    reader = csv.reader(file)
                    r = 0
